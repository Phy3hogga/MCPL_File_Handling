...
function Merged_File_Path = MCPL_Merge_Chunks(Datastore_Directory_Path, Header, Output_File_Path, Remove_Temp_Files)
    ...
    disp("MCPL_Merge_Chunks : Merging Datastore Partitions.");
